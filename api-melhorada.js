// ========================================
// CRIMINAL MINDS GAME - API MELHORADA
...
app.post('/api/game/create', authenticateToken, async (req, res) => {
  try {
    const { mode = 'cards', maxPlayers = 6 } = req.body;
    ...
    console.log(`🎮 Nova sala criada: ${gameCode} por ${req.user.detectiveName}`);
...
const server = app.listen(PORT, async () => {
  try {
    ...
    console.log('🚀 API Server melhorada rodando na porta', PORT);
